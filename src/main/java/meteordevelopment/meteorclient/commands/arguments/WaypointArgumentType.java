...
public class WaypointArgumentType implements ArgumentType<String> {
   ...
   private static final DynamicCommandExceptionType NO_SUCH_WAYPOINT = new DynamicCommandExceptionType(
      name -> Component.literal("Waypoint with name '" + name + "' doesn't exist.")
   );
