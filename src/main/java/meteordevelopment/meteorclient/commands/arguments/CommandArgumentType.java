...
public class CommandArgumentType implements ArgumentType<Command> {
   ...
   private static final DynamicCommandExceptionType NO_SUCH_COMMAND = new DynamicCommandExceptionType(
      name -> Component.literal("Command with name '" + name + "' doesn't exist.")
   );
