   ...
   public static void load(FontFace fontFace) {
      ...
      try {
         ...
         if (fontFace.equals(DEFAULT_FONT)) {
            throw new RuntimeException("Failed to load default font: " + fontFace, var2);
         }

         MeteorClient.LOG.error("Failed to load font: " + fontFace, var2);
         load(DEFAULT_FONT);
      }

      if (MeteorClient.mc.screen instanceof WidgetScreen && Config.get().customFont.get()) {
