...
public class Selection implements ISelection {
   ...
   public Selection(BetterBlockPos pos1, BetterBlockPos pos2) {
      ...
      this.aabb = new AABB(
         (double)this.min.x, (double)this.min.y, (double)this.min.z, (double)(this.max.x + 1), (double)(this.max.y + 1), (double)(this.max.z + 1)
      );
   }
   ...
   public ISelection expand(Direction direction, int blocks) {
      return this.isPos2(direction)
         ? new Selection(this.pos1, this.pos2.relative(direction, blocks))
         : new Selection(this.pos1.relative(direction, blocks), this.pos2);
   }
   ...
   public ISelection shift(Direction direction, int blocks) {
      return new Selection(this.pos1.relative(direction, blocks), this.pos2.relative(direction, blocks));
   }
}
