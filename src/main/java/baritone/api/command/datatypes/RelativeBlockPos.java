...
public enum RelativeBlockPos implements IDatatypePost<BetterBlockPos, BetterBlockPos> {
   ...
   public BetterBlockPos apply(IDatatypeContext ctx, BetterBlockPos origin) throws CommandException {
      ...
      return new BetterBlockPos(
         consumer.<Double, Double, RelativeCoordinate>getDatatypePost(RelativeCoordinate.INSTANCE, (double)origin.x),
         consumer.<Double, Double, RelativeCoordinate>getDatatypePost(RelativeCoordinate.INSTANCE, (double)origin.y),
         consumer.<Double, Double, RelativeCoordinate>getDatatypePost(RelativeCoordinate.INSTANCE, (double)origin.z)
      );
   }
